...
const productName = "RepoBar";
const productDescription = "RepoBar shows GitHub repository status in the macOS menu bar and terminal: CI, issues, pull requests, and latest releases.";
const source = "https://github.com/steipete/RepoBar";
